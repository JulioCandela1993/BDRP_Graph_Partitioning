...
declare -a algs=('InitializeSampleRD' 'InitializeSampleHD') 
...
declare -a files=(RoadCanada.vertex BerkeleyStan.vertex Youtube.vertex RoadItaly.vertex) # )testfile.txt lastfm_asia_edges.txt)
