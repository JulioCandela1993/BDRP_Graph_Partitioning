...
public class BGRAP_PartitionedVertexInputFormat
		extends TextVertexInputFormat<BGRAP_LongWritable, DoubleWritable, DoubleWritable> {
	...
	public class SpinnerLongDoubleDoubleVertexReader extends TextVertexReaderFromEachLineProcessed<String[]> {
		...
		@Override
		protected DoubleWritable getValue(String[] data) throws IOException {
