 ...
 */
public class BGRAP_LongDoubleTextEdgeInputFormat extends
    TextEdgeInputFormat<BGRAP_LongWritable, DoubleWritable> {
  /** Splitter for endpoints */
  private static final Pattern SEPARATOR = Pattern.compile("[\t ]");

  @Override
  public EdgeReader<BGRAP_LongWritable, DoubleWritable> createEdgeReader(
  ...
  public class LongLongDoubleTextEdgeReader extends
    ...
    @Override
    protected BGRAP_LongWritable getSourceVertexId(String[] tokens)
      throws IOException {
      return new BGRAP_LongWritable(Long.parseLong(tokens[0]));
    }

    @Override
    protected BGRAP_LongWritable getTargetVertexId(String[] tokens)
      throws IOException {
    ...
    protected DoubleWritable getValue(String[] tokens)
      throws IOException {
    	if(tokens.length>2) return new DoubleWritable(Double.parseDouble(tokens[2]));
