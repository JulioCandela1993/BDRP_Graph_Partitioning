 ...
 */
public class LongDoubleNullTextInputFormat extends
  ...
  public TextVertexReader createVertexReader(InputSplit split,
    ...
    throws IOException {
    return new LongDoubleDoubleVertexReader();
  }

  /**
   * Vertex reader associated with {@link LongLongNullLongTextInputFormat}.
   */
  public class LongDoubleDoubleVertexReader extends
    ...
    @Override
    protected List<Edge<LongWritable, NullWritable>> getEdges(
