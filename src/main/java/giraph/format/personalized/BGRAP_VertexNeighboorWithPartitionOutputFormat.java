 ...
 *
 * Each line consists of: vertex_partition neighbor1_partition neighbor2_partition ...
 * (for example : 1250_1 189_1 1251_3  ...
 * 
 * @author Adnan EL MOUSSAWI
 *
 */
public class BGRAP_VertexNeighboorWithPartitionOutputFormat
		...
		protected Text convertVertexToLine(Vertex<LongWritable, VertexValue, EdgeValue> vertex)
			...
			for (Edge<LongWritable, EdgeValue> edge : vertex.getEdges()) {
				sb.append(delimiter).append(
						...
						edge.getTargetVertexId().get() + "_" + edge.getValue().getPartition()
						);
			}
