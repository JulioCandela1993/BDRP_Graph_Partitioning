...
public class PersonalizedGiraphJob implements Tool {
	 ...
	 * HDFS Node address
	 */
	private String hdfsNode = "hdfs://localhost:9000<";
	/**
	...
	protected void useAcceleratedSetting(GiraphConfiguration giraphConf) {
		 ...
		 */
		int numThreads = 1;
		GiraphConfiguration.NUM_INPUT_THREADS.set(giraphConf, 1);
		GiraphConfiguration.NUM_OUTPUT_THREADS.set(giraphConf, numThreads);
		GiraphConfiguration.NUM_COMPUTE_THREADS.set(giraphConf, 1);
