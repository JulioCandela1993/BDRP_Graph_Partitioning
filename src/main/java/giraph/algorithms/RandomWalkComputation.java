 ...
 * @param <E> edge type
 */
public abstract class RandomWalkComputation<E extends DoubleWritable>
    extends BasicComputation<BGRAP_LongWritable, DoubleWritable, E, DoubleWritable> {
  ...
  protected abstract double transitionProbability(
      Vertex<BGRAP_LongWritable, DoubleWritable, E> vertex,
      double stateProbability,
      Edge<BGRAP_LongWritable, E> edge);
  ...
  public void compute(
    ...
    if (getSuperstep() < maxSupersteps()) {
      for (Edge<BGRAP_LongWritable, E> edge : vertex.getEdges()) {
