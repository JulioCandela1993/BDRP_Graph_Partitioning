 ...
 */
public class MaxComputation extends BasicComputation<BGRAP_LongWritable, IntWritable,
    NullWritable, IntWritable> {
  @Override
  public void compute(Vertex<BGRAP_LongWritable, IntWritable, NullWritable> vertex,
