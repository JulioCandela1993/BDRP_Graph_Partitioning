...
public class SimpleInDegreeCountComputation
		extends BasicComputation<BGRAP_LongWritable, DoubleWritable, DoubleWritable, DoubleWritable> {

	@SuppressWarnings("unused")
	@Override
	public void compute(Vertex<BGRAP_LongWritable, DoubleWritable, DoubleWritable> vertex,
			Iterable<DoubleWritable> messages) throws IOException {
		if (getSuperstep() == 0) {
			Iterable<Edge<BGRAP_LongWritable, DoubleWritable>> edges = vertex.getEdges();
			for (Edge<BGRAP_LongWritable, DoubleWritable> edge : edges) {
