...
public class SimpleShortestPathsComputation extends BasicComputation<
    BGRAP_LongWritable, DoubleWritable, DoubleWritable, DoubleWritable> {
   ...
   */
  private boolean isSource(Vertex<BGRAP_LongWritable, ?, ?> vertex) {
    return vertex.getId().getId() == SOURCE_ID.get(getConf());
  }
